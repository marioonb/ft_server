...
#RUN apt-get install maria_db-server mariadb-client
#RUN apt installer php7.3 php7.3-fpm php7.3-mysql php-common php7.3-cli php7.3-common
...
#&& tar -xzf latest-fr_FR.tar.gz -C /usr/local --strip-components=1 \
